  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_Login_respaldo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_app_Login_respaldo_form();
        }
...
?>
  ...
  function do_ajax_app_Login_respaldo_validate_id_inv_curso_fk()
  {
    ...
    x_ajax_app_Login_respaldo_validate_id_inv_curso_fk(var_id_inv_curso_fk, var_script_case_init, do_ajax_app_Login_respaldo_validate_id_inv_curso_fk_cb);
  } // do_ajax_app_Login_respaldo_validate_id_inv_curso_fk

  function do_ajax_app_Login_respaldo_validate_id_inv_curso_fk_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_validate_id_inv_curso_fk_cb

  // ---------- Validate horas_part
  function do_ajax_app_Login_respaldo_validate_horas_part()
  {
    var nomeCampo_horas_part = "horas_part";
    var var_horas_part = scAjaxGetFieldText(nomeCampo_horas_part);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_validate_horas_part(var_horas_part, var_script_case_init, do_ajax_app_Login_respaldo_validate_horas_part_cb);
  } // do_ajax_app_Login_respaldo_validate_horas_part

  function do_ajax_app_Login_respaldo_validate_horas_part_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_validate_horas_part_cb

  // ---------- Validate alimentos
  function do_ajax_app_Login_respaldo_validate_alimentos()
  {
    var nomeCampo_alimentos = "alimentos";
    var var_alimentos = scAjaxGetFieldSelect(nomeCampo_alimentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_validate_alimentos(var_alimentos, var_script_case_init, do_ajax_app_Login_respaldo_validate_alimentos_cb);
  } // do_ajax_app_Login_respaldo_validate_alimentos

  function do_ajax_app_Login_respaldo_validate_alimentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_validate_alimentos_cb

  // ---------- Validate hosp_ent
  function do_ajax_app_Login_respaldo_validate_hosp_ent()
  {
    var nomeCampo_hosp_ent = "hosp_ent";
    var var_hosp_ent = scAjaxGetFieldText(nomeCampo_hosp_ent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_validate_hosp_ent(var_hosp_ent, var_script_case_init, do_ajax_app_Login_respaldo_validate_hosp_ent_cb);
  } // do_ajax_app_Login_respaldo_validate_hosp_ent

  function do_ajax_app_Login_respaldo_validate_hosp_ent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_validate_hosp_ent_cb

  // ---------- Validate hosp_sal
  function do_ajax_app_Login_respaldo_validate_hosp_sal()
  {
    var nomeCampo_hosp_sal = "hosp_sal";
    var var_hosp_sal = scAjaxGetFieldText(nomeCampo_hosp_sal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_validate_hosp_sal(var_hosp_sal, var_script_case_init, do_ajax_app_Login_respaldo_validate_hosp_sal_cb);
  } // do_ajax_app_Login_respaldo_validate_hosp_sal

  function do_ajax_app_Login_respaldo_validate_hosp_sal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_validate_hosp_sal_cb

  // ---------- Validate transp_terr
  function do_ajax_app_Login_respaldo_validate_transp_terr()
  {
    var nomeCampo_transp_terr = "transp_terr";
    var var_transp_terr = scAjaxGetFieldSelect(nomeCampo_transp_terr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_validate_transp_terr(var_transp_terr, var_script_case_init, do_ajax_app_Login_respaldo_validate_transp_terr_cb);
  } // do_ajax_app_Login_respaldo_validate_transp_terr

  function do_ajax_app_Login_respaldo_validate_transp_terr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_validate_transp_terr_cb

  // ---------- Validate transp_aer
  function do_ajax_app_Login_respaldo_validate_transp_aer()
  {
    var nomeCampo_transp_aer = "transp_aer";
    var var_transp_aer = scAjaxGetFieldSelect(nomeCampo_transp_aer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_validate_transp_aer(var_transp_aer, var_script_case_init, do_ajax_app_Login_respaldo_validate_transp_aer_cb);
  } // do_ajax_app_Login_respaldo_validate_transp_aer

  function do_ajax_app_Login_respaldo_validate_transp_aer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_validate_transp_aer_cb

  // ---------- Validate trans_aer_ida
  function do_ajax_app_Login_respaldo_validate_trans_aer_ida()
  {
    var nomeCampo_trans_aer_ida = "trans_aer_ida";
    var var_trans_aer_ida = scAjaxGetFieldText(nomeCampo_trans_aer_ida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_validate_trans_aer_ida(var_trans_aer_ida, var_script_case_init, do_ajax_app_Login_respaldo_validate_trans_aer_ida_cb);
  } // do_ajax_app_Login_respaldo_validate_trans_aer_ida

  function do_ajax_app_Login_respaldo_validate_trans_aer_ida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_validate_trans_aer_ida_cb

  // ---------- Validate trans_aer_vuelta
  function do_ajax_app_Login_respaldo_validate_trans_aer_vuelta()
  {
    var nomeCampo_trans_aer_vuelta = "trans_aer_vuelta";
    var var_trans_aer_vuelta = scAjaxGetFieldText(nomeCampo_trans_aer_vuelta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_validate_trans_aer_vuelta(var_trans_aer_vuelta, var_script_case_init, do_ajax_app_Login_respaldo_validate_trans_aer_vuelta_cb);
  } // do_ajax_app_Login_respaldo_validate_trans_aer_vuelta

  function do_ajax_app_Login_respaldo_validate_trans_aer_vuelta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_validate_trans_aer_vuelta_cb

  // ---------- Validate notas
  function do_ajax_app_Login_respaldo_validate_notas()
  {
    var nomeCampo_notas = "notas";
    var var_notas = scAjaxGetFieldText(nomeCampo_notas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_validate_notas(var_notas, var_script_case_init, do_ajax_app_Login_respaldo_validate_notas_cb);
  } // do_ajax_app_Login_respaldo_validate_notas

  function do_ajax_app_Login_respaldo_validate_notas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_validate_notas_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_app_Login_respaldo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app_Login_respaldo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_app_Login_respaldo_submit_form(var_id_inv_curso_fk, var_horas_part, var_alimentos, var_hosp_ent, var_hosp_sal, var_transp_terr, var_transp_aer, var_trans_aer_ida, var_trans_aer_vuelta, var_notas, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_Login_respaldo_submit_form_cb);
  } // do_ajax_app_Login_respaldo_submit_form

  function do_ajax_app_Login_respaldo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app_Login_respaldo_submit_form_cb_after_alert);
  } // do_ajax_app_Login_respaldo_submit_form_cb
  function do_ajax_app_Login_respaldo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app_Login_respaldo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app_Login_respaldo_navigate_form()
  {
    perform_ajax_app_Login_respaldo_navigate_form();
  }

  function perform_ajax_app_Login_respaldo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_app_Login_respaldo_navigate_form(var_id_sol_gtos_profinv, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_Login_respaldo_navigate_form_cb);
  } // do_ajax_app_Login_respaldo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_respaldo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app_Login_respaldo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app_Login_respaldo_navigate_form_cb_after_alert);
  } // do_ajax_app_Login_respaldo_navigate_form_cb
  function do_ajax_app_Login_respaldo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app_Login_respaldo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app_Login_respaldo_navigate_form_cb_after_alert

  function sc_hide_app_Login_respaldo_form()
  {
