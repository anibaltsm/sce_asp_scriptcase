  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_Login_respaldo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_app_Login_respaldo_mob_form();
        }
...
?>
  ...
  // ---------- Validate id_inv_curso_fk
  function do_ajax_app_Login_respaldo_mob_validate_id_inv_curso_fk()
  {
    var nomeCampo_id_inv_curso_fk = "id_inv_curso_fk";
    var var_id_inv_curso_fk = scAjaxGetFieldSelect(nomeCampo_id_inv_curso_fk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_mob_validate_id_inv_curso_fk(var_id_inv_curso_fk, var_script_case_init, do_ajax_app_Login_respaldo_mob_validate_id_inv_curso_fk_cb);
  } // do_ajax_app_Login_respaldo_mob_validate_id_inv_curso_fk

  function do_ajax_app_Login_respaldo_mob_validate_id_inv_curso_fk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "id_inv_curso_fk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_mob_validate_id_inv_curso_fk_cb

  // ---------- Validate horas_part
  function do_ajax_app_Login_respaldo_mob_validate_horas_part()
  {
    var nomeCampo_horas_part = "horas_part";
    var var_horas_part = scAjaxGetFieldText(nomeCampo_horas_part);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_mob_validate_horas_part(var_horas_part, var_script_case_init, do_ajax_app_Login_respaldo_mob_validate_horas_part_cb);
  } // do_ajax_app_Login_respaldo_mob_validate_horas_part

  function do_ajax_app_Login_respaldo_mob_validate_horas_part_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "horas_part";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_mob_validate_horas_part_cb

  // ---------- Validate alimentos
  function do_ajax_app_Login_respaldo_mob_validate_alimentos()
  {
    var nomeCampo_alimentos = "alimentos";
    var var_alimentos = scAjaxGetFieldSelect(nomeCampo_alimentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_mob_validate_alimentos(var_alimentos, var_script_case_init, do_ajax_app_Login_respaldo_mob_validate_alimentos_cb);
  } // do_ajax_app_Login_respaldo_mob_validate_alimentos

  function do_ajax_app_Login_respaldo_mob_validate_alimentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "alimentos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_mob_validate_alimentos_cb

  // ---------- Validate hosp_ent
  function do_ajax_app_Login_respaldo_mob_validate_hosp_ent()
  {
    var nomeCampo_hosp_ent = "hosp_ent";
    var var_hosp_ent = scAjaxGetFieldText(nomeCampo_hosp_ent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_mob_validate_hosp_ent(var_hosp_ent, var_script_case_init, do_ajax_app_Login_respaldo_mob_validate_hosp_ent_cb);
  } // do_ajax_app_Login_respaldo_mob_validate_hosp_ent

  function do_ajax_app_Login_respaldo_mob_validate_hosp_ent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "hosp_ent";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_mob_validate_hosp_ent_cb

  // ---------- Validate hosp_sal
  function do_ajax_app_Login_respaldo_mob_validate_hosp_sal()
  {
    var nomeCampo_hosp_sal = "hosp_sal";
    var var_hosp_sal = scAjaxGetFieldText(nomeCampo_hosp_sal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_mob_validate_hosp_sal(var_hosp_sal, var_script_case_init, do_ajax_app_Login_respaldo_mob_validate_hosp_sal_cb);
  } // do_ajax_app_Login_respaldo_mob_validate_hosp_sal

  function do_ajax_app_Login_respaldo_mob_validate_hosp_sal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "hosp_sal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_mob_validate_hosp_sal_cb

  // ---------- Validate transp_terr
  function do_ajax_app_Login_respaldo_mob_validate_transp_terr()
  {
    var nomeCampo_transp_terr = "transp_terr";
    var var_transp_terr = scAjaxGetFieldSelect(nomeCampo_transp_terr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_mob_validate_transp_terr(var_transp_terr, var_script_case_init, do_ajax_app_Login_respaldo_mob_validate_transp_terr_cb);
  } // do_ajax_app_Login_respaldo_mob_validate_transp_terr

  function do_ajax_app_Login_respaldo_mob_validate_transp_terr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "transp_terr";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_mob_validate_transp_terr_cb

  // ---------- Validate transp_aer
  function do_ajax_app_Login_respaldo_mob_validate_transp_aer()
  {
    var nomeCampo_transp_aer = "transp_aer";
    var var_transp_aer = scAjaxGetFieldSelect(nomeCampo_transp_aer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_mob_validate_transp_aer(var_transp_aer, var_script_case_init, do_ajax_app_Login_respaldo_mob_validate_transp_aer_cb);
  } // do_ajax_app_Login_respaldo_mob_validate_transp_aer

  function do_ajax_app_Login_respaldo_mob_validate_transp_aer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "transp_aer";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_mob_validate_transp_aer_cb

  // ---------- Validate trans_aer_ida
  function do_ajax_app_Login_respaldo_mob_validate_trans_aer_ida()
  {
    var nomeCampo_trans_aer_ida = "trans_aer_ida";
    var var_trans_aer_ida = scAjaxGetFieldText(nomeCampo_trans_aer_ida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_mob_validate_trans_aer_ida(var_trans_aer_ida, var_script_case_init, do_ajax_app_Login_respaldo_mob_validate_trans_aer_ida_cb);
  } // do_ajax_app_Login_respaldo_mob_validate_trans_aer_ida

  function do_ajax_app_Login_respaldo_mob_validate_trans_aer_ida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "trans_aer_ida";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_mob_validate_trans_aer_ida_cb

  // ---------- Validate trans_aer_vuelta
  function do_ajax_app_Login_respaldo_mob_validate_trans_aer_vuelta()
  {
    var nomeCampo_trans_aer_vuelta = "trans_aer_vuelta";
    var var_trans_aer_vuelta = scAjaxGetFieldText(nomeCampo_trans_aer_vuelta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_mob_validate_trans_aer_vuelta(var_trans_aer_vuelta, var_script_case_init, do_ajax_app_Login_respaldo_mob_validate_trans_aer_vuelta_cb);
  } // do_ajax_app_Login_respaldo_mob_validate_trans_aer_vuelta

  function do_ajax_app_Login_respaldo_mob_validate_trans_aer_vuelta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "trans_aer_vuelta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_mob_validate_trans_aer_vuelta_cb

  // ---------- Validate notas
  function do_ajax_app_Login_respaldo_mob_validate_notas()
  {
    var nomeCampo_notas = "notas";
    var var_notas = scAjaxGetFieldText(nomeCampo_notas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_respaldo_mob_validate_notas(var_notas, var_script_case_init, do_ajax_app_Login_respaldo_mob_validate_notas_cb);
  } // do_ajax_app_Login_respaldo_mob_validate_notas

  function do_ajax_app_Login_respaldo_mob_validate_notas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_respaldo_mob_validate_notas_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_app_Login_respaldo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app_Login_respaldo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_inv_curso_fk = scAjaxGetFieldSelect("id_inv_curso_fk");
    var var_horas_part = scAjaxGetFieldText("horas_part");
    var var_alimentos = scAjaxGetFieldSelect("alimentos");
    var var_hosp_ent = scAjaxGetFieldText("hosp_ent");
    var var_hosp_sal = scAjaxGetFieldText("hosp_sal");
    var var_transp_terr = scAjaxGetFieldSelect("transp_terr");
    var var_transp_aer = scAjaxGetFieldSelect("transp_aer");
    var var_trans_aer_ida = scAjaxGetFieldText("trans_aer_ida");
    var var_trans_aer_vuelta = scAjaxGetFieldText("trans_aer_vuelta");
    var var_notas = scAjaxGetFieldText("notas");
    var var_id_sol_gtos_profinv = scAjaxGetFieldText("id_sol_gtos_profinv");
    ...
    scAjaxProcOn();
    x_ajax_app_Login_respaldo_mob_submit_form(var_id_inv_curso_fk, var_horas_part, var_alimentos, var_hosp_ent, var_hosp_sal, var_transp_terr, var_transp_aer, var_trans_aer_ida, var_trans_aer_vuelta, var_notas, var_id_sol_gtos_profinv, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_Login_respaldo_mob_submit_form_cb);
  } // do_ajax_app_Login_respaldo_mob_submit_form

  function do_ajax_app_Login_respaldo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_inv_curso_fk");
      scAjaxHideErrorDisplay("horas_part");
      scAjaxHideErrorDisplay("alimentos");
      scAjaxHideErrorDisplay("hosp_ent");
      scAjaxHideErrorDisplay("hosp_sal");
      scAjaxHideErrorDisplay("transp_terr");
      scAjaxHideErrorDisplay("transp_aer");
      scAjaxHideErrorDisplay("trans_aer_ida");
      scAjaxHideErrorDisplay("trans_aer_vuelta");
      scAjaxHideErrorDisplay("notas");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app_Login_respaldo_mob_submit_form_cb_after_alert);
  } // do_ajax_app_Login_respaldo_mob_submit_form_cb
  function do_ajax_app_Login_respaldo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app_Login_respaldo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app_Login_respaldo_mob_navigate_form()
  {
    perform_ajax_app_Login_respaldo_mob_navigate_form();
  }

  function perform_ajax_app_Login_respaldo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("trans_aer_vuelta");
    scAjaxHideErrorDisplay("notas");
    var var_id_sol_gtos_profinv = document.F2.id_sol_gtos_profinv.value;
    ...
    scAjaxProcOn();
    x_ajax_app_Login_respaldo_mob_navigate_form(var_id_sol_gtos_profinv, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_Login_respaldo_mob_navigate_form_cb);
  } // do_ajax_app_Login_respaldo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_respaldo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app_Login_respaldo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_sol_gtos_profinv.value = scAjaxGetKeyValue("id_sol_gtos_profinv");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app_Login_respaldo_mob_navigate_form_cb_after_alert);
  } // do_ajax_app_Login_respaldo_mob_navigate_form_cb
  function do_ajax_app_Login_respaldo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app_Login_respaldo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app_Login_respaldo_mob_navigate_form_cb_after_alert

  function sc_hide_app_Login_respaldo_mob_form()
  {
  ...
  ajax_field_list[0] = "id_inv_curso_fk";
  ajax_field_list[1] = "horas_part";
  ajax_field_list[2] = "alimentos";
  ajax_field_list[3] = "hosp_ent";
  ajax_field_list[4] = "hosp_sal";
  ajax_field_list[5] = "transp_terr";
  ajax_field_list[6] = "transp_aer";
  ajax_field_list[7] = "trans_aer_ida";
  ajax_field_list[8] = "trans_aer_vuelta";
  ajax_field_list[9] = "notas";
  ...
  var ajax_error_list = {
    "id_inv_curso_fk": {"label": "<?php echo $this->Ini->Nm_lang['lang_sol_gtos_prof_inv_fld_id_inv_curso_FK'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "horas_part": {"label": "<?php echo $this->Ini->Nm_lang['lang_sol_gtos_prof_inv_fld_horas_part'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "alimentos": {"label": "<?php echo $this->Ini->Nm_lang['lang_sol_gtos_prof_inv_fld_alimentos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hosp_ent": {"label": "<?php echo $this->Ini->Nm_lang['lang_sol_gtos_prof_inv_fld_hosp_ent'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hosp_sal": {"label": "<?php echo $this->Ini->Nm_lang['lang_sol_gtos_prof_inv_fld_hosp_sal'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "transp_terr": {"label": "<?php echo $this->Ini->Nm_lang['lang_sol_gtos_prof_inv_fld_transp_terr'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "transp_aer": {"label": "<?php echo $this->Ini->Nm_lang['lang_sol_gtos_prof_inv_fld_transp_aer'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "trans_aer_ida": {"label": "<?php echo $this->Ini->Nm_lang['lang_sol_gtos_prof_inv_fld_trans_aer_ida'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "trans_aer_vuelta": {"label": "<?php echo $this->Ini->Nm_lang['lang_sol_gtos_prof_inv_fld_trans_aer_vuelta'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "notas": {"label": "<?php echo $this->Ini->Nm_lang['lang_sol_gtos_prof_inv_fld_notas'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_inv_curso_fk": new Array(),
    "horas_part": new Array(),
    "alimentos": new Array(),
    "hosp_ent": new Array(),
    "hosp_sal": new Array(),
    "transp_terr": new Array(),
    "transp_aer": new Array(),
    "trans_aer_ida": new Array(),
    "trans_aer_vuelta": new Array(),
    "notas": new Array()
  };
  ajax_field_mult["id_inv_curso_fk"][1] = "id_inv_curso_fk";
  ajax_field_mult["horas_part"][1] = "horas_part";
  ajax_field_mult["alimentos"][1] = "alimentos";
  ajax_field_mult["hosp_ent"][1] = "hosp_ent";
  ajax_field_mult["hosp_sal"][1] = "hosp_sal";
  ajax_field_mult["transp_terr"][1] = "transp_terr";
  ajax_field_mult["transp_aer"][1] = "transp_aer";
  ajax_field_mult["trans_aer_ida"][1] = "trans_aer_ida";
  ajax_field_mult["trans_aer_vuelta"][1] = "trans_aer_vuelta";
  ajax_field_mult["notas"][1] = "notas";

  var ajax_field_id = {
    "id_inv_curso_fk": new Array("hidden_field_label_id_inv_curso_fk", "hidden_field_data_id_inv_curso_fk"),
    "horas_part": new Array("hidden_field_label_horas_part", "hidden_field_data_horas_part"),
    "alimentos": new Array("hidden_field_label_alimentos", "hidden_field_data_alimentos"),
    "hosp_ent": new Array("hidden_field_label_hosp_ent", "hidden_field_data_hosp_ent"),
    "hosp_sal": new Array("hidden_field_label_hosp_sal", "hidden_field_data_hosp_sal"),
    "transp_terr": new Array("hidden_field_label_transp_terr", "hidden_field_data_transp_terr"),
    "transp_aer": new Array("hidden_field_label_transp_aer", "hidden_field_data_transp_aer"),
    "trans_aer_ida": new Array("hidden_field_label_trans_aer_ida", "hidden_field_data_trans_aer_ida"),
    "trans_aer_vuelta": new Array("hidden_field_label_trans_aer_vuelta", "hidden_field_data_trans_aer_vuelta"),
    "notas": new Array("hidden_field_label_notas", "hidden_field_data_notas")
  };
