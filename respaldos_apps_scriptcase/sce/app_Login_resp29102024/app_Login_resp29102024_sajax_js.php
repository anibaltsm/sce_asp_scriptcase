  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_Login_resp29102024" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_app_Login_resp29102024_form();
        }
...
?>
  ...
  // ---------- Validate login
  function do_ajax_app_Login_resp29102024_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_resp29102024_validate_login(var_login, var_script_case_init, do_ajax_app_Login_resp29102024_validate_login_cb);
  } // do_ajax_app_Login_resp29102024_validate_login

  function do_ajax_app_Login_resp29102024_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_resp29102024_validate_login_cb

  // ---------- Validate pswd
  function do_ajax_app_Login_resp29102024_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_resp29102024_validate_pswd(var_pswd, var_script_case_init, do_ajax_app_Login_resp29102024_validate_pswd_cb);
  } // do_ajax_app_Login_resp29102024_validate_pswd

  function do_ajax_app_Login_resp29102024_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_resp29102024_validate_pswd_cb

  // ---------- Validate links
  function do_ajax_app_Login_resp29102024_validate_links()
  {
    var nomeCampo_links = "links";
    var var_links = scAjaxGetFieldText(nomeCampo_links);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_resp29102024_validate_links(var_links, var_script_case_init, do_ajax_app_Login_resp29102024_validate_links_cb);
  } // do_ajax_app_Login_resp29102024_validate_links

  function do_ajax_app_Login_resp29102024_validate_links_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_resp29102024_validate_links_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_app_Login_resp29102024_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app_Login_resp29102024_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_app_Login_resp29102024_submit_form(var_login, var_pswd, var_links, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_Login_resp29102024_submit_form_cb);
  } // do_ajax_app_Login_resp29102024_submit_form

  function do_ajax_app_Login_resp29102024_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app_Login_resp29102024_submit_form_cb_after_alert);
  } // do_ajax_app_Login_resp29102024_submit_form_cb
  function do_ajax_app_Login_resp29102024_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app_Login_resp29102024_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app_Login_resp29102024_navigate_form()
  {
    perform_ajax_app_Login_resp29102024_navigate_form();
  }

  function perform_ajax_app_Login_resp29102024_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_app_Login_resp29102024_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_resp29102024']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app_Login_resp29102024_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app_Login_resp29102024_navigate_form_cb_after_alert);
  } // do_ajax_app_Login_resp29102024_navigate_form_cb
  function do_ajax_app_Login_resp29102024_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('login');
...
{
?>
    do_ajax_app_Login_resp29102024_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app_Login_resp29102024_navigate_form_cb_after_alert

  function sc_hide_app_Login_resp29102024_form()
  {
