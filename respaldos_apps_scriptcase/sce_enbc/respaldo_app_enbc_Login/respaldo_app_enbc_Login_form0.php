...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>respaldo_app_enbc_Login/respaldo_app_enbc_Login_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("respaldo_app_enbc_Login_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('respaldo_app_enbc_Login_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['link_info']['remove_border']) {
...
<?php
 include_once("respaldo_app_enbc_Login_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['respaldo_app_enbc_Login'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['respaldo_app_enbc_Login'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['where_filter']))
       {
...
?> 
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_remember_me" style="<?php echo $sStyleHidden_remember_me; ?>"> <table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_remember_me_label" style=" padding: 0px; width: 100%;"><span id="id_label_remember_me"><?php echo $this->nm_new_label['remember_me']; ?></span></td></tr><tr><td class="css_remember_me_line" style="padding: 0px; width: 100%;">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['Lookup_remember_me'][] = '1'; ?>
...
<input type="hidden" name="new_user_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_new_user('app_enbc_form_add_users', '_self')"><?php echo $this->Ini->Nm_lang['lang_new_user'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
...
<input type="hidden" name="retrieve_pswd_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_retrieve_pswd('app_enbc_retrieve_pswd', '_self')"><?php echo $this->Ini->Nm_lang['lang_subject_mail'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['btn_label']['ok'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("respaldo_app_enbc_Login");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("respaldo_app_enbc_Login");
 parent.scAjaxDetailHeight("respaldo_app_enbc_Login", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['respaldo_app_enbc_Login']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
