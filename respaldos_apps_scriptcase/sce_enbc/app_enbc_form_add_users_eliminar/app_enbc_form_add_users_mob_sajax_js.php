  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_enbc_form_add_users_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_app_enbc_form_add_users_mob_form();
	}
...
?>
  ...
  // ---------- Validate mensaje
  function do_ajax_app_enbc_form_add_users_mob_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldHidden(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_enbc_form_add_users_mob_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_app_enbc_form_add_users_mob_validate_mensaje_cb);
  } // do_ajax_app_enbc_form_add_users_mob_validate_mensaje

  function do_ajax_app_enbc_form_add_users_mob_validate_mensaje_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_enbc_form_add_users_mob_validate_mensaje_cb

  // ---------- Validate name
  function do_ajax_app_enbc_form_add_users_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_enbc_form_add_users_mob_validate_name(var_name, var_script_case_init, do_ajax_app_enbc_form_add_users_mob_validate_name_cb);
  } // do_ajax_app_enbc_form_add_users_mob_validate_name

  function do_ajax_app_enbc_form_add_users_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_enbc_form_add_users_mob_validate_name_cb

  // ---------- Validate apat
  function do_ajax_app_enbc_form_add_users_mob_validate_apat()
  {
    var nomeCampo_apat = "apat";
    var var_apat = scAjaxGetFieldText(nomeCampo_apat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_enbc_form_add_users_mob_validate_apat(var_apat, var_script_case_init, do_ajax_app_enbc_form_add_users_mob_validate_apat_cb);
  } // do_ajax_app_enbc_form_add_users_mob_validate_apat

  function do_ajax_app_enbc_form_add_users_mob_validate_apat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "apat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_enbc_form_add_users_mob_validate_apat_cb

  // ---------- Validate amat
  function do_ajax_app_enbc_form_add_users_mob_validate_amat()
  {
    var nomeCampo_amat = "amat";
    var var_amat = scAjaxGetFieldText(nomeCampo_amat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_enbc_form_add_users_mob_validate_amat(var_amat, var_script_case_init, do_ajax_app_enbc_form_add_users_mob_validate_amat_cb);
  } // do_ajax_app_enbc_form_add_users_mob_validate_amat

  function do_ajax_app_enbc_form_add_users_mob_validate_amat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "amat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_enbc_form_add_users_mob_validate_amat_cb

  // ---------- Validate email
  function do_ajax_app_enbc_form_add_users_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_enbc_form_add_users_mob_validate_email(var_email, var_script_case_init, do_ajax_app_enbc_form_add_users_mob_validate_email_cb);
  } // do_ajax_app_enbc_form_add_users_mob_validate_email

  function do_ajax_app_enbc_form_add_users_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_enbc_form_add_users_mob_validate_email_cb

  // ---------- Validate nota
  function do_ajax_app_enbc_form_add_users_mob_validate_nota()
  {
    var nomeCampo_nota = "nota";
    var var_nota = scAjaxGetFieldHidden(nomeCampo_nota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_enbc_form_add_users_mob_validate_nota(var_nota, var_script_case_init, do_ajax_app_enbc_form_add_users_mob_validate_nota_cb);
  } // do_ajax_app_enbc_form_add_users_mob_validate_nota

  function do_ajax_app_enbc_form_add_users_mob_validate_nota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nota";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_enbc_form_add_users_mob_validate_nota_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_app_enbc_form_add_users_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app_enbc_form_add_users_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_mensaje = scAjaxGetFieldHidden("mensaje");
    ...
    var var_nota = scAjaxGetFieldHidden("nota");
    ...
    scAjaxProcOn();
    x_ajax_app_enbc_form_add_users_mob_submit_form(var_mensaje, var_name, var_apat, var_amat, var_email, var_nota, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_enbc_form_add_users_mob_submit_form_cb);
  } // do_ajax_app_enbc_form_add_users_mob_submit_form

  function do_ajax_app_enbc_form_add_users_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app_enbc_form_add_users_mob_submit_form_cb_after_alert);
  } // do_ajax_app_enbc_form_add_users_mob_submit_form_cb
  function do_ajax_app_enbc_form_add_users_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app_enbc_form_add_users_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app_enbc_form_add_users_mob_navigate_form()
  {
    perform_ajax_app_enbc_form_add_users_mob_navigate_form();
  }

  function perform_ajax_app_enbc_form_add_users_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_app_enbc_form_add_users_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_enbc_form_add_users_mob_navigate_form_cb);
  } // do_ajax_app_enbc_form_add_users_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_enbc_form_add_users_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app_enbc_form_add_users_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app_enbc_form_add_users_mob_navigate_form_cb_after_alert);
  } // do_ajax_app_enbc_form_add_users_mob_navigate_form_cb
  function do_ajax_app_enbc_form_add_users_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app_enbc_form_add_users_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app_enbc_form_add_users_mob_navigate_form_cb_after_alert

  function sc_hide_app_enbc_form_add_users_mob_form()
  {
  ...
  ajax_field_list[0] = "mensaje";
  ajax_field_list[1] = "name";
  ajax_field_list[2] = "apat";
  ajax_field_list[3] = "amat";
  ajax_field_list[4] = "email";
  ajax_field_list[5] = "nota";
  ...
  var ajax_error_list = {
    ...
    "apat": {"label": "Apellido paterno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "amat": {"label": "Apellido materno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "Correo electrónico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nota": {"label": "Nota importante", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "nota": new Array("hidden_field_label_nota", "hidden_field_data_nota")
  };
