...
function scHidePage(pageNo) {
	$("#id_app_enbc_form_add_users_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_alta" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_app_enbc_form_add_users_mob_validate_fecha_alta(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_picture" + iSeqRow).fileupload({
    datatype: "json",
    url: "app_enbc_form_add_users_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'app_enbc_form_add_users_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
