...
class app_form_add_users_correcto_erro
{
   var $Ini;
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe=true, $err_usr=false)
   {
      ...
      $this->monta_mensagem();
      return app_form_add_users_correcto_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe, $err_usr);
   }
