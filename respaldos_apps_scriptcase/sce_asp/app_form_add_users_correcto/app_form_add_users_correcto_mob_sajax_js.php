  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_form_add_users_correcto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_app_form_add_users_correcto_mob_form();
        }
...
?>
  ...
  // ---------- Validate login
  function do_ajax_app_form_add_users_correcto_mob_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_correcto_mob_validate_login(var_login, var_script_case_init, do_ajax_app_form_add_users_correcto_mob_validate_login_cb);
  } // do_ajax_app_form_add_users_correcto_mob_validate_login

  function do_ajax_app_form_add_users_correcto_mob_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_correcto_mob_validate_login_cb

  // ---------- Validate pswd
  function do_ajax_app_form_add_users_correcto_mob_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_correcto_mob_validate_pswd(var_pswd, var_script_case_init, do_ajax_app_form_add_users_correcto_mob_validate_pswd_cb);
  } // do_ajax_app_form_add_users_correcto_mob_validate_pswd

  function do_ajax_app_form_add_users_correcto_mob_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_correcto_mob_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_app_form_add_users_correcto_mob_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_correcto_mob_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_app_form_add_users_correcto_mob_validate_confirm_pswd_cb);
  } // do_ajax_app_form_add_users_correcto_mob_validate_confirm_pswd

  function do_ajax_app_form_add_users_correcto_mob_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_correcto_mob_validate_confirm_pswd_cb

  // ---------- Validate name
  function do_ajax_app_form_add_users_correcto_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_correcto_mob_validate_name(var_name, var_script_case_init, do_ajax_app_form_add_users_correcto_mob_validate_name_cb);
  } // do_ajax_app_form_add_users_correcto_mob_validate_name

  function do_ajax_app_form_add_users_correcto_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_correcto_mob_validate_name_cb

  // ---------- Validate apat
  function do_ajax_app_form_add_users_correcto_mob_validate_apat()
  {
    var nomeCampo_apat = "apat";
    var var_apat = scAjaxGetFieldText(nomeCampo_apat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_correcto_mob_validate_apat(var_apat, var_script_case_init, do_ajax_app_form_add_users_correcto_mob_validate_apat_cb);
  } // do_ajax_app_form_add_users_correcto_mob_validate_apat

  function do_ajax_app_form_add_users_correcto_mob_validate_apat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_correcto_mob_validate_apat_cb

  // ---------- Validate amat
  function do_ajax_app_form_add_users_correcto_mob_validate_amat()
  {
    var nomeCampo_amat = "amat";
    var var_amat = scAjaxGetFieldText(nomeCampo_amat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_correcto_mob_validate_amat(var_amat, var_script_case_init, do_ajax_app_form_add_users_correcto_mob_validate_amat_cb);
  } // do_ajax_app_form_add_users_correcto_mob_validate_amat

  function do_ajax_app_form_add_users_correcto_mob_validate_amat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_correcto_mob_validate_amat_cb

  // ---------- Validate email
  function do_ajax_app_form_add_users_correcto_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_correcto_mob_validate_email(var_email, var_script_case_init, do_ajax_app_form_add_users_correcto_mob_validate_email_cb);
  } // do_ajax_app_form_add_users_correcto_mob_validate_email

  function do_ajax_app_form_add_users_correcto_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_correcto_mob_validate_email_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_app_form_add_users_correcto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app_form_add_users_correcto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_apat = scAjaxGetFieldText("apat");
    var var_amat = scAjaxGetFieldText("amat");
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_correcto_mob_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_apat, var_amat, var_email, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_add_users_correcto_mob_submit_form_cb);
  } // do_ajax_app_form_add_users_correcto_mob_submit_form

  function do_ajax_app_form_add_users_correcto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("apat");
      scAjaxHideErrorDisplay("amat");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app_form_add_users_correcto_mob_submit_form_cb_after_alert);
  } // do_ajax_app_form_add_users_correcto_mob_submit_form_cb
  function do_ajax_app_form_add_users_correcto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app_form_add_users_correcto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app_form_add_users_correcto_mob_navigate_form()
  {
    perform_ajax_app_form_add_users_correcto_mob_navigate_form();
  }

  function perform_ajax_app_form_add_users_correcto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_correcto_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_add_users_correcto_mob_navigate_form_cb);
  } // do_ajax_app_form_add_users_correcto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_correcto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app_form_add_users_correcto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app_form_add_users_correcto_mob_navigate_form_cb_after_alert);
  } // do_ajax_app_form_add_users_correcto_mob_navigate_form_cb
  function do_ajax_app_form_add_users_correcto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app_form_add_users_correcto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app_form_add_users_correcto_mob_navigate_form_cb_after_alert

  function sc_hide_app_form_add_users_correcto_mob_form()
  {
  ...
  ajax_field_list[4] = "apat";
  ajax_field_list[5] = "amat";
  ...
  var ajax_error_list = {
    "login": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_asp_users_fld_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pswd": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_asp_users_fld_pswd'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "name": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_asp_users_fld_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "apat": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_asp_users_fld_apat'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "amat": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_asp_users_fld_amat'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_asp_users_fld_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["apat"][1] = "apat";
  ajax_field_mult["amat"][1] = "amat";
  ...
  var ajax_field_id = {
    ...
    "apat": new Array("hidden_field_label_apat", "hidden_field_data_apat"),
    "amat": new Array("hidden_field_label_amat", "hidden_field_data_amat"),
