...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['app_form_add_users_correcto']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['app_form_add_users_correcto']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['app_form_add_users_correcto']['upload_field_info'][ $_POST['param_field'] ];
